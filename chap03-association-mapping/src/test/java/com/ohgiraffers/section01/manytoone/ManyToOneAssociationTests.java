...
public class ManyToOneAssociationTests {
    ...
    * 객체 간의 연관관계를 양방향으로 만들고 싶을 경우 반대 쪽에서도 필드를 추가하여
    * 참조를 보관할 수 있다.
    ...
    * */
    ...
    @Test
    @DisplayName("다대일 연관관계 객체 지향 쿼리(JPQL) 사용한 카테고리 이름 조회 테스트")
    public void test2() {
        ...
        // when
        // 조회 시 조인 구문이 실행되며 연관 테이블을 함께 조회
    ...
    * 영속성 전이 : 특정 엔티티를 영속화할 때, 연관된 엔티티도 함께 영속화를 진행한다는 의미
    * */
